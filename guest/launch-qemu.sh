...
SVSM=""
CONSOLE="serial"
UEFI_BIOS_CODE="$(pwd)/../host/qemu/usr/local/share/qemu/OVMF_CODE.fd"
UEFI_BIOS_VARS="$(pwd)/../host/qemu/usr/local/share/qemu/OVMF_VARS.fd"
BIOS_DEBUG=""
VNC_PORT=""
ALLOW_DEBUG=""
USE_VIRTIO="1"
...
QEMU_INSTALL_DIR="$(pwd)/../host/qemu/usr/local/bin/"
